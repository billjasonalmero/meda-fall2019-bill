...
function letterCount(text,char){
  ...
  if(text == undefined) {
    console.log("You did not provide provide a string to test on!");
    return;
  }

  if (char == undefined) {
    console.log("This function call is an argument to fully run! Stopping now.");
    return;
  }
  ...
  var lengthOfString = stringToTest.lenght;
